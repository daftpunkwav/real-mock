...
SESSIONS_MIGRATIONS: dict[str, list[str]] = {
    "prep_sessions": [
        ...
        "ALTER TABLE prep_sessions ADD COLUMN last_round_prompt_tokens INTEGER DEFAULT 0",
        "ALTER TABLE prep_sessions ADD COLUMN last_round_completion_tokens INTEGER DEFAULT 0",

"""
@file cascaded.py
@description Cascaded implementation of RealtimeAudioEngine (STT -> LLM -> Sentence TTS).
...
- Provide low-latency pipelined synthesis without blocking the conversational turn.
"""

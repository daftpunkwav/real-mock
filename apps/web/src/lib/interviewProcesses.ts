/**
 * Pure helpers for multi-round interview process continuation (no React / no API).
 *
 * Lives in lib so other features can index eligible processes without importing
 * the interview feature barrel (which pulls in the room UI).
 */

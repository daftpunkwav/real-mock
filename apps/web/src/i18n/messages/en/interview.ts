...
export const interview = {
  ...
  "setup.section.goal": "Goal",
  "setup.section.format": "Format",
  "setup.section.presenter": "Interviewer & Resume",
  ...
  "setup.strictness.label": "Strictness",
  "setup.strictness.easy": "Easygoing",
  "setup.strictness.friendly": "Friendly",
  "setup.strictness.balanced": "Balanced",
  "setup.strictness.strict": "Strict",
  "setup.strictness.harsh": "Harsh",
  "setup.strictness.relentless": "Relentless",
  ...
  "preview.process": "Interview flow",
  "preview.flow.noResume":
    "No resume linked: AI falls back to generic questions with weaker deep dives. Link a resume first.",
  "preview.brief.loading": "AI is researching {name}'s interview style…",
  "preview.brief.error": "Research failed — the network or model may be temporarily unavailable.",
  "preview.brief.retry": "Retry",
